...
from .serializers import UserLoginSerializer, PatientRegistrationSerializer, DoctorRegistrationSerializer 
...
class JWTDoctorAuthentication(authentication.BaseAuthentication):
    ...
    def _authenticate_credentials(self, request, token):
        ...
        try:
            user = Doctor.objects.get(pk=payload['id'])
